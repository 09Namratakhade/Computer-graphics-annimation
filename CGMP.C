// birthday wishes using Computer graphics
#include <conio.h>
#include <stdio.h>
#include <dos.h>
#include <stdlib.h>
...
int Entry()
{
	...
	for (r = 0; r < 2500; r++)
	{
		...
		circle(170, 300, 10);
		settextstyle(10, 0, 4); // sets font,direction,font_size of text(to set bold character)
		setcolor(10);
		outtextxy(156, 290, "O");
		setcolor(15);
		line(170, 350, 166, 400); // left leg of img
		line(170, 350, 174, 400); // right leg of img
		line(0, 400, 700, 400);
		line(157, 320, 147, 350);
		line(177, 317, 188, 350);
		settextstyle(2, 0, 7);
		// for desplaying the text like continuously
		if (r == 30)
		{
...
int Entry3()
{
	...
	for (j = 0; j < 5; j++)
	{
		...
		settextstyle(10, 0, 6); // to set bold character
		setcolor(2);
		outtextxy(14, 250, "W"); // x,ycordinates and a character to display
		setcolor(3);
		outtextxy(110, 250, "I");
		setcolor(4);
		outtextxy(140, 250, "S");
		...
		setcolor(11);
		outtextxy(370, 250, "U");
		settextstyle(11, 0, 8); // 11 for bold font , 8 is font size
...
int cake()
{
	...
	setfillstyle(INTERLEAVE_FILL, 9); // pattern, color
	circle(198, 379, 8);
	...
	// write your name instead of shubham name.

	outtextxy(340, 360, "- FROM AMAN TO SHUBHAM.");
